...
public class CubeSphere : MonoBehaviour {
	...
	private Color32[] cubeUV = new Color32[]{};


	private int[] trianglesX = new int[]{}; 
	private int[] trianglesY = new int[]{}; 
	private int[] trianglesZ = new int[]{}; 
	...
	private void CreateTriangles () {
		...
		int verticesCount = (gridSize * gridSize) * 12;
		trianglesZ = new int[verticesCount];
		trianglesX = new int[verticesCount];
		trianglesY = new int[verticesCount];
